...
export function Nav() {
  ...
  return (
    ...
    >
      <nav className="mx-auto flex max-w-[1440px] items-center gap-3 px-5 sm:gap-6 sm:px-8 lg:px-12">
        <a href="#top" className="flex min-w-0 shrink-0 items-center gap-2.5 text-cypress sm:gap-3" aria-label={`${site.name}, home`}>
          <Crest className="h-8 w-auto text-brass sm:h-9" />
          <Wordmark className="text-[0.68rem] sm:text-[0.86rem]" />
        </a>
        ...
        <a
          ...
          className="ml-auto flex shrink-0 items-center gap-2.5 border border-cypress/25 px-3.5 py-3 text-[0.78rem] tracking-wide whitespace-nowrap text-cypress transition-colors hover:border-cypress hover:bg-cypress hover:text-limestone sm:px-4 sm:py-2.5 lg:ml-0"
        >
